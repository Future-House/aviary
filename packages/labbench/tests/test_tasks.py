...
@pytest.fixture(name="imageqa_settings", scope="module")
def fixture_imageqa_settings() -> Settings:
    return Settings(
...
class TestImageQATaskDataset:
    ...
    async def test_figqa(self, imageqa_settings: Settings) -> None:
        ...
        assert (
            added_doc.citation
            == "Row ID 792c87ca-0925-434b-b1e5-d8198ec6bac1 filename 058.jpg"
        )
    ...
    async def test_tableqa(self, imageqa_settings: Settings) -> None:
        ...
        assert (
            added_doc1.citation
            == "Row ID 1fbf9336-f853-4cdd-a1ec-5a757b9b9128 filename 271.png"
        )
        assert (
            added_doc2.citation
            == "Row ID 1fbf9336-f853-4cdd-a1ec-5a757b9b9128 filename 272.png"
        )
