...
Copy the following into a file and run it. To run this, you will need the [`ldp`](https://github.com/Future-House/ldp) and [`fhaviary[lfrqa]`](https://github.com/Future-House/aviary/tree/main/packages/lfrqa)) packages installed.
